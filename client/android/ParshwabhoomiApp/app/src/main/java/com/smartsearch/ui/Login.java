...
import com.smartsearch.parse.LoginResult;
import com.smartsearch.util.SmartSearchLocationListener;
			...
			public void run()
			{
				try
				{
					...
					if(loginResult.getStatus().equalsIgnoreCase("True"))
					{
						...
						i.setClassName(Login.this, com.smartsearch.ui.SearchScreen.class.getName());
